...
class TrajectoryEngine:
    ...
    def generate_deterministic_candidate_paths(
        ...
        path_ai = CandidatePath(
            ...
            transparency_summary={
                "what_we_know": ["Academic background in mathematics and computer science", "Demonstrated Python scripting experience"],
                "how_we_know_it": ["User profile declaration", "Observable task evaluation"],
                "what_remains_unknown": ["Formal deep learning framework benchmark", "Production inference deployment repository"],
                "what_could_change_this": ["Submission of verified PyTorch repository or model serving latency benchmark"]
            },
            required_skills=[
                "Python & Modern C++",
        ...
        path_robotics = CandidatePath(
            ...
            transparency_summary={
                "what_we_know": ["Hands-on hardware/Arduino project experience", "Realistic psychometric alignment"],
                "how_we_know_it": ["User profile submissions", "RIASEC assessment responses"],
                "what_remains_unknown": ["ROS 2 navigation stack mastery", "RTOS embedded simulation evidence"],
                "what_could_change_this": ["Verified ROS 2 workspace or physical robot navigation demo"]
            },
            required_skills=[
        ...
        path_cloud = CandidatePath(
            ...
            transparency_summary={
                "what_we_know": ["Analytical problem solving and architecture trade-off understanding"],
                "how_we_know_it": ["Observable task response"],
                "what_remains_unknown": ["Linux server administration", "Kubernetes cluster deployments"],
                "what_could_change_this": ["Verified containerized deployment with Terraform or Kubernetes manifests"]
            },
            required_skills=[
